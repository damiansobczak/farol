    ...
    <div class="mt-6">
        ...
        <nav class="text-gray-200" aria-labelledby="shop-nav">
            <ul>
                ...
                <li>
                    <a href="{{ route('admin.categories') }}" class="text-sm w-full block px-5 py-2 hover:bg-gray-700 flex items-center {!! request()->routeIs('admin.categories') ? 'bg-indigo-500 font-medium text-white' : '' !!}}">
                        <svg class="mr-2" height="16" width="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="mt-6">
        ...
        <nav class="text-gray-200" aria-labelledby="cms-nav">
            <ul>
                ...
                <li>
                <a href="{{ route('admin.realisations') }}" class="text-sm w-full block px-5 py-2 hover:bg-gray-700 flex items-center {!! request()->routeIs('admin.realisations') ? 'bg-indigo-500 font-medium text-white' : '' !!}">
                        <svg class="mr-2" height="16" width="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
