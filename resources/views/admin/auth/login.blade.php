    ...
    <div class="container mx-auto w-full h-full flex justify-center items-center">
        <form class="md:w-1/2 xl:w-2/6 h-auto bg-white p-8 rounded shadow">
            ...
            <label for="password" class="text-sm text-gray-400 my-4 block">
                ...
                <input class="font-light hover:border-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 placeholder-gray-300 w-full p-3 rounded border border-gray-200"type="password" name="password" id="password" placeholder="Hasło jest ukryte">
            </label>
            <label for="remember" class="flex items-center block cursor-pointer mb-3">
                <input type="checkbox" id="remember" name="checked-demo" checked class="font-light appearance-none form-tick h-5 w-5 border text-xs rounded border-gray-200 rounded-md checked:bg-indigo-600 checked:border-transparent focus:outline-none">
            ...
            <div class="mt-5 flex items-center justify-between">
                ...
                <a href="#" class="text-indigo-400 text-sm underline hover:text-indigo-300">Zapomniałeś hasła?</a>
            </div>
        </form>
    </div>
@endsection
