	...
	<div class="container mx-auto">
		<div class="flex items-end mb-4">
			...
			<div class="flex items-center ml-auto">
				<button class="rounded-full border border-gray-100 p-3 cursor-pointer hover:bg-gray-50" id="popular-left">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="rgb(31, 41, 55)" class="w-5 h-5">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
					</svg>
				</button>
				<button class="rounded-full border border-gray-100 p-3 cursor-pointer hover:bg-gray-50 mx-3" id="popular-right">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="rgb(31, 41, 55)" class="w-5 h-5">
