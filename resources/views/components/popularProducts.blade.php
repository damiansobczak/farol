            ...
            <div class="flex items stretch flex-nowrap w-full min-w-full transition-all" id="popular-products">
                <div class="flex-shrink-0 w-1/2 md:w-1/3 lg:w-1/5 px-2 -ml-2" id="popular-product">
                    <div class="border px-3 py-6 text-center rounded-md relative group">
                        <img src="{{ asset('img/product.png') }}" alt="" class="w-auto max-h-52 mx-auto" />
                        <span class="uppercase text-xs text-gray-400">Rolety wolnowiszące</span>
                        <p class="text-gray-800 font-semibold">Roleta CODA</p>
                ...
                <div class="flex-shrink-0 w-1/2 md:w-1/3 lg:w-1/5 px-2" id="popular-product">
                    <div class="border px-3 py-6 text-center rounded-md relative group">
                        <img src="{{ asset('img/product.png') }}" alt="" class="w-auto max-h-52 mx-auto" />
                        <span class="uppercase text-xs text-gray-400">Rolety wolnowiszące</span>
                        <p class="text-gray-800 font-semibold">Roleta CODA</p>
