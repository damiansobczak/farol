<div class="container mx-auto w-full my-12 h-full flex justify-center items-center">
    <form method="POST" action="" class="md:w-1/2 xl:w-2/6 h-auto bg-white p-8 rounded shadow">
        ...
        <div class="pb-3 border-b border-gray-200">
            ...
            <p class="text-gray-400 text-sm font-light">Wiadomość z linkiem resetującym hasło zostanie wysłana na podany
                niżej adres email.</p>
        </div>
        ...
        <label for="email" class="text-sm text-gray-400 my-4 block">
            ...
            <input
                ...
                type="email" name="email" id="email" placeholder="np. admin@poczta.pl">
        </label>
        <button class="bg-green-500 py-2 px-3 rounded text-white text-sm hover:bg-green-700" type="submit">Wyślij
