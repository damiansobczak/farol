<nav aria-label="Main Navigation" class="container mx-auto text-sm flex items-center py-5 justify-between relative border-b border-gray-100 z-40">
	...
	<ul class="md:flex items-center hidden absolute md:static top-full bg-white rounded-sm shadow-lg leading-10	w-64 md:w-auto md:shadow-none" id="menu">
		...
		<li>
			<a href="#" class="px-3 py-2 hover:text-green-600 font-medium" id="menu-popover-trigger" aria-expanded="false">Produkty</a>
			<div class="flex flex-col md:flex-row bg-none bg-transparent md:bg-white w-full mx-auto max-w-fluid md:fixed left-0 right-0 md:top-52 lg:top-44 border border-gray-100 py-2 md:py-6 hidden opacity-0" id="menu-popover">
				<div class="bg-gray-100 md:bg-transparent border-r border-gray-100 border-solid px-3 md:px-5 font-medium w-full md:w-64 mb-3 md:mb-0 text-gray-800">
					Nasz asortyment
				</div>
